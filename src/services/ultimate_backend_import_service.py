        ...
        if existing:
            ...
            db.execute(
                ...
                SET title            = COALESCE(?, title),
                    ...
                    epg_event_id     = COALESCE(?, epg_event_id),
        ...
        try:
            ...
            db.execute(
                ...
                INSERT OR IGNORE INTO programs (
                    ...
                    category, ultimate_epg_id, schedule_id, epg_event_id,
                    season_num, episode_num, has_episode_info,
                    director, directors, actors, producer, producers,
                    writers, presenters,
                    production_year, language, rating, thumbnail_url, images
                ) VALUES (
                    ?, ?, ?, ?,
                    ?, ?, ?,
                    ?, ?, ?, ?,
                ...
                if existing:
                    db.execute(
                        ...
                        SET title = ?, subtitle = ?, description = ?,
                            ...
                            director = ?, directors = ?, actors = ?, producer = ?, producers = ?,
                            writers = ?, presenters = ?,
                            production_year = ?, language = ?, rating = ?, 
